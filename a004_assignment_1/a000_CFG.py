...
PIECES_DATA_FOLDER = DATA_FOLDER / "a004_pieces"
...
NDJSON_FILE_NAME_TO_LOAD = NDJSON_FILE_NAME_LIST[2]
NDJSON_TOTAL_LINE_NUM = LINE_NUM_INFO[NDJSON_FILE_NAME_TO_LOAD]

FILE_PIECES_FOR_MPI_V4 = 8
